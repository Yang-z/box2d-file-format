...
auto db2ChunkType_CSON::RegisterType() -> bool
{
    ...
    db2Reflector::Reflect<db2Chunk<db2Dict>>(db2ChunkType_CSON::DIcT);
    db2Reflector::Reflect<db2Chunk<db2List>>(db2ChunkType_CSON::LIsT);
    db2Reflector::Reflect<db2Chunk<db2String>>(db2ChunkType_CSON::STrG);
